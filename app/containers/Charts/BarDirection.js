...
function BarDirection() {
  ...
  return (
    <div>
      ...
      <PapperBlock title="Basic Bar Example" icon="ion-ios-stats-outline" desc="">
        <BarBasic />
        <SourceReader componentName={docSrc + 'BarBasic.js'} />
      </PapperBlock>
      <PapperBlock title="Horizontal Bar Example" icon="ion-ios-stats-outline" desc="">
        <BarHorizontal />
        <SourceReader componentName={docSrc + 'BarHorizontal.js'} />
      </PapperBlock>
      <PapperBlock title="Crazy Random Graph" icon="ion-ios-stats-outline" desc="">
        <BarDynamic />
