...
function DoughnutCharts() {
  ...
  return (
    <div>
      ...
      <PapperBlock title="Doughnut Example" icon="ion-ios-pie-outline" desc="">
        <DoughnutBasic />
        <SourceReader componentName={docSrc + 'DoughnutBasic.js'} />
      </PapperBlock>
      <PapperBlock title="Dynamicly Doughnut" icon="ion-ios-pie-outline" desc="Dynamicly refreshed Doughnut Example">
        <DoughnutDynamic />
        <SourceReader componentName={docSrc + 'DoughnutDynamic.js'} />
      </PapperBlock>
      <PapperBlock title="Simple Pie Example" icon="ion-ios-pie-outline" desc="">
        <PieSimple2 />
