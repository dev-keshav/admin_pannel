...
function AreaFilledChart() {
  ...
  return (
    <div>
      ...
      <PapperBlock title="Basic Area Example" icon="ion-ios-analytics-outline" desc="">
        <AreaBasic />
        <SourceReader componentName={docSrc + 'AreaBasic.js'} />
      </PapperBlock>
      <PapperBlock title="Dynamic Area Example" icon="ion-ios-analytics-outline" desc="">
        <AreaDynamic />
