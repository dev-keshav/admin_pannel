...
function ImageGrid() {
  ...
  return (
    <div>
      ...
      <PapperBlock title="Image-only Grid list" icon="ion-ios-grid" desc="A simple example of a scrollable image GridList">
        <div>
          <ImageGridList />
          <SourceReader componentName={docSrc + 'ImageGridList.js'} />
        </div>
      </PapperBlock>
      <PapperBlock title="Grid list with titlebars" icon="ion-ios-keypad-outline" desc="This example demonstrates the use of the GridListTileBar to add an overlay to each GridListTile.">
        <div>
          <TitlebarGridList />
      ...
      <PapperBlock title="Single line Grid list" icon="ion-ios-barcode" desc="This example demonstrates a horizontal scrollable single-line grid list of images.">
        <div>
          <SingleLineGridList />
